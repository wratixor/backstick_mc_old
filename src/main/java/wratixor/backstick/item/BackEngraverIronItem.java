...
public class BackEngraverIronItem extends Item {
	public BackEngraverIronItem() {
		super(new Item.Properties().tab(BackstickModTabs.TAB_TAB_BS).durability(250).fireResistant().rarity(Rarity.UNCOMMON));
	}
