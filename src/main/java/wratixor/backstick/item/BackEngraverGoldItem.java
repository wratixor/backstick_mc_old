...
public class BackEngraverGoldItem extends Item {
	public BackEngraverGoldItem() {
		super(new Item.Properties().tab(BackstickModTabs.TAB_TAB_BS).durability(32).fireResistant().rarity(Rarity.UNCOMMON));
	}
